...
public class FwRunner {
    ...
    public int run(String[] args){
        if (args.length < 2) {
            System.err.println("Invalid input. need AT LEAST bla bla...");
            return 1;
        }
        ...
        try {
            ...
            System.err.println("Invalid input. invalid PATH bla bla...");
            return 1;
        }

        if (!Files.exists(rulesPath)) {
            System.err.println("Invalid input. invalid RULES PATH permissions bla bla...");
            return 1;
        }
        if (!Files.exists(hostsFolderPath) || !Files.isDirectory(hostsFolderPath)) {
            System.err.println("Invalid input. invalid HOSTS PATH permissions bla bla...");
            return 1;
        }
